...
public class MapActivity extends AppCompatActivity implements
    ...
    public static String geoJson = "initialization";
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(ChoosePOICategory.destinationCoordinates.getLatitude(), ChoosePOICategory.destinationCoordinates.getLongitude());
